-- V1: quant core schema for MariaDB
...
CREATE INDEX idx_orders_portfolio_date ON orders(portfolio_id, trade_date);
CREATE INDEX idx_orders_symbol_date ON orders(symbol, trade_date);
...
CREATE INDEX idx_trades_symbol_time ON trades(symbol, traded_at);
...
CREATE INDEX idx_positions_portfolio_date ON positions(portfolio_id, as_of_date);
...
CREATE INDEX idx_ledger_account_date ON ledger_entries(account_code, entry_date);
CREATE INDEX idx_ledger_portfolio_date ON ledger_entries(portfolio_id, entry_date);
