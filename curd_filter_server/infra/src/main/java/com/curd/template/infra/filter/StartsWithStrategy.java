...
public class StartsWithStrategy implements FilterOperatorStrategy {
    ...
    public BooleanExpression build(PathBuilder<?> root, String field, Class<?> fieldType, String rawValue) {
        return PredicateSupport.stringPath(root, field, fieldType).startsWithIgnoreCase(rawValue);
    }
}
