...
import com.example.samplesaga.order.application.SagaOrderNotFoundException;
...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleNotFound(SagaOrderNotFoundException exception) {
