package com.example.commerce.account.config;
...
/**
 * Account Service를 Keycloak JWT 기반 무상태 Resource Server로 구성한다.
 */
@Configuration
...
public class AccountSecurityConfiguration {
    ...
    /**
     * Account Service 보안 구성을 생성한다.
     */
    public AccountSecurityConfiguration() {
    }

    /**
     * 상태 확인과 관측성 엔드포인트는 공개하고 계좌 API에는 계좌 또는 관리자 role을 요구한다.
     *
     * @param http Servlet HTTP 보안 구성기
     * @param properties OAuth2 활성화 설정
     * @return Account Service 보안 필터 체인
