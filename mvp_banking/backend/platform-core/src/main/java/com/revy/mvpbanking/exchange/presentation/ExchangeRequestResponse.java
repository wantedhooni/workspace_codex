...
public record ExchangeRequestResponse(
    ...
    public static ExchangeRequestResponse from(ExchangeRequest exchangeRequest) {
        return new ExchangeRequestResponse(
                ...
                exchangeRequest.getAppliedRateEffectiveAt(),
                exchangeRequest.getRequestMemo(),
                exchangeRequest.isSameDaySettlementEligible(),
                exchangeRequest.getExpectedSettlementAt(),
                exchangeRequest.isManualReviewRequired(),
                exchangeRequest.getManualReviewReason(),
                exchangeRequest.getCancellationReason(),
                exchangeRequest.getCanceledAt(),
